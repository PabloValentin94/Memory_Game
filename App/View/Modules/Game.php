...
<html lang="pt-br">
    ...
    <body oncontextmenu="return false">
        ...
        <div id="initialization">
            ...
            <button onclick="iniciar_jogo()">  </button>
        ...
        <div id="time_banner">
            ...
            <div>
                ...
                <p> <span id="horas" style="color: #00007D;">  </span> : <span id="minutos" style="color: #00007D;">  </span> : <span id="segundos" style="color: #00007D;">  </span> </p>
                ...
                <button onclick="window.location.reload(true);"> Recarregar Jogo </button>
